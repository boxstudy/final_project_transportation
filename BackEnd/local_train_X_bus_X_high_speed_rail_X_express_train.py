...
class LocalTrain_X_Bus_X_HighSpeedRail_X_ExpressTrain(ComplexTransport):
    stations = LocalTrain_X_HighSpeedRail_X_ExpressTrain.stations | Bus.stations
    def __init__(self, departure_time: str, start: str, end: str, discount: bool, reserved: bool):
        ...
        self.bus = Bus("", "", "")
        self.local_train_X_high_speed_rail_X_express_train = LocalTrain_X_HighSpeedRail_X_ExpressTrain("", "", "", discount, reserved)

    def _create(self):

        Bus_transfer_points = ["花蓮"]
        LocalTrain_X_HighSpeedRail_X_ExpressTrain_transfer_points = ["花蓮"]
        ...
        self.paths = super()._switch_by_transfer_points(departure_time=self.departure_time,
                                                        ...
                                                        transportation_b=self.local_train_X_high_speed_rail_X_express_train,
                                                        transfer_points_a=Bus_transfer_points,
                                                        transfer_points_b=LocalTrain_X_HighSpeedRail_X_ExpressTrain_transfer_points)