...
class LocalTrain(Transportation):
    stations = {
        ...
        "濁水", "源泉", "二水", "枋寮", "東海", "佳冬", "林邊", "鎮安", "南州", "崁頂", "潮州", "竹田", "西勢", "麟洛",
        "歸來", "屏東", "六塊厝", "九曲堂", "後庄", "鳳山", "正義", "科工館", "民族", "高雄", "三塊厝", "鼓山", "美術館",
        "內惟", "左營", "新左營", "楠梓", "橋頭", "岡山", "路竹", "大湖", "中洲", "仁德", "保安", "臺南", "大橋", "永康",
        "新市", "南科", "善化", "拔林", "隆田", "林鳳營", "柳營", "新營", "後壁", "南靖", "水上", "嘉義", "基隆", "三坑",
        "八堵", "七堵", "百福", "五堵", "汐止", "汐科", "南港", "松山", "臺北", "萬華", "板橋", "浮洲", "樹林", "南樹林",
        "山佳", "鶯歌", "鳳鳴", "桃園", "內壢", "中壢", "埔心", "楊梅", "富岡", "新富", "北湖", "湖口", "新豐", "竹北",
        "三姓橋", "香山", "崎頂", "竹南", "談文", "大山", "後龍", "龍港", "白沙屯", "新埔", "通霄", "苑裡", "日南", "大甲",
        "臺中港", "清水", "沙鹿", "龍井", "大肚", "追分", "彰化", "造橋", "豐富", "苗栗", "南勢", "銅鑼", "三義", "泰安",
        "后里", "豐原", "栗林", "潭子", "頭家厝", "松竹", "太原", "精武", "臺中", "五權", "大慶", "烏日", "新烏日", "成功",
        "花蓮", "吉安", "志學", "平和", "壽豐", "豐田", "林榮新光", "南平", "鳳林", "萬榮", "光復", "大富", "富源", "瑞穗",
        "三民", "玉里", "東里", "東竹", "富里", "池上", "海端", "關山", "瑞和", "瑞源", "鹿野", "山里", "臺東", "康樂", "知本",
        "太麻里", "金崙", "瀧溪", "大武", "枋山", "內獅", "加祿", "嘉北", "民雄", "大林", "石龜", "斗南", "斗六", "石榴",
        "林內", "田中", "社頭", "永靖", "員林", "大村", "花壇", "北埔", "景美", "新城", "崇德", "和仁", "和平", "漢本", "武塔",
        "南澳", "東澳", "永樂", "蘇澳新", "蘇澳", "四腳亭", "瑞芳", "猴硐", "三貂嶺", "牡丹", "雙溪", "貢寮", "福隆", "石城",
        "大里", "大溪", "龜山", "外澳", "頭城", "頂埔", "礁溪", "四城", "宜蘭", "二結", "中里", "羅東", "冬山", "新馬"
    }
